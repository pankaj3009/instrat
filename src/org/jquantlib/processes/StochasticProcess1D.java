 ...
 * {
 *
 * @latex[ dx_t = \mu(t, x_t)dt + \sigma(t, x_t)dW_t }
 *
...
public abstract class StochasticProcess1D extends StochasticProcess {
     ...
     * {@link Discretization} <b>and</b> {@link Discretization1D}.
     */
     ...
     *
     * @latex$ E(x_{t_0 + \Delta t} | x_{t_0} = x_0) } of the process after a
     * time interval {
     ...
     *
     * @latex$ S(x_{t_0 + \Delta t} | x_{t_0} = x_0) } of the process after a
     * time interval {
     * @latex$ \Delta t } according to the given discretization. This method can
     * be overridden in derived classes which want to hard-code a particular
     * discretization.
     ...
     *
     * @latex$ V(x_{t_0 + \Delta t} | x_{t_0} = x_0) } of the process after a
     * time interval {
     * @latex$ \Delta t } according to the given discretization. This method can
     * be overridden in derived classes which want to hard-code a particular
     * discretization.
     ...
     * returns {
     * @latex[ E(x_0,t_0,\Delta t) + S(x_0,t_0,\Delta t) \cdot \Delta w } where
     * {
    ...
    public interface Discretization1D {
         ...
         * Returns the variance {
         *
         * @latex$ V(x_{t_0 + \Delta t} | x_{t_0} = x_0) } of the process after
         * a time interval {
