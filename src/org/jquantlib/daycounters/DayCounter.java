...
/**
 * This interface provides methods for determining the length of a time period
 * according to given market convention, both as a number of days and as a year
 * fraction.
 *
...
public class DayCounter {
    ...
    /**
     * Returns the period between two dates as a fraction of year, considering
     * referencing dates for both.
     *
     * @param dateStart
     * @param dateEnd
     * @param refPeriodStart
     * @param refPeriodEnd
     * @return the period between two dates as a fraction of year, considering
     * referencing dates for both.
     */
    ...
    /**
     * Returns <tt>true</tt> if <code>this</code> and <code>other</code> belong
     * to the same derived class.
     */
