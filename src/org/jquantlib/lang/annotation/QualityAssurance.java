...
public @interface QualityAssurance {
    ...
    public enum Quality {
        ...
        Q0_UNFINISHED,
        /**
         * Translation finished, no translation issues, not doubts, no pending
         * items.
         */
        Q1_TRANSLATION,
        /**
         * JQuantLib API resembles QuantLib API close enough, including operator
         * overloading, if any
         */
        Q2_RESEMBLANCE,
        /**
         * License, header comments, class comments, @Override, access
         * modifiers,
         */
        Q3_DOCUMENTATION,
        /**
        ...
        Q4_UNIT,
        /**
         * Pass on integration tests, such as sample code which exercises the
         * functionality
         */
        Q5_INTEGRATION,
        /**
