 ...
 * <li>long a {@link PlainVanillaPayoff} at the first strike (same CALL/PUT
 * type) and</li>
 * <li>short a {@link CashOrNothingPayoff} at the first strike (same CALL/PUT
 * type) with cash payoff equal to the difference between the second and the
 * first strike.</li>
 * <p>
...
public class GapPayoff extends StrikedTypePayoff {
     ...
     *
     * @latex$ S_{T}} finishes below/above the first strike price {
     * @latex$ K_{1}}, or pays out the difference between the asset price {
     * @latex$ S_{T}} and the second strike price {
     * @latex$ K_{2}} if the underlying asset finishes above/below the first
     * strike price {
     * @latex$ K_{1}}.
     * <li>CALL Option: if {
     * @latex$ S_{T}>K_{1} \rightarrow S_{T}-K_{2}}, otherwise zero</li>
     * <li>PUT Option: if {
     * @latex$ K_{1}>S_{T} \rightarrow K_{2}-S_{T}}, otherwise zero</li>
     * where {
     * @latex$ S_{T}} is the asset price at maturity, {
     * @latex$ K_{1}} is the first strike and {
     * @latex$ K_{2}} is the second strike.
     */
    @Override
