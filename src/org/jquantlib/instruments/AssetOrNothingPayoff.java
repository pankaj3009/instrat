...
/**
 * Binary <i>asset-or-nothing</i> payoff which pays off nothing if the
 * underlying asset price {
 *
 * @latex$ S_{T}} finishes below/above the strike price {
 * @latex$ K}, or pays out the asset price {
 * @latex$ S_{T}} itself if the underlying asset finishes above/below the strike
 * price.
 * <p>
...
public class AssetOrNothingPayoff extends StrikedTypePayoff {
     ...
     * policy of an <i>asset-or-nothing</i> payoff
     *
     ...
     * @latex$ S_{T}} finishes below/above the strike price {
     * @latex$ K}, or pays out the asset price {
     * @latex$ S_{T}} itself if the underlying asset finishes above/below the
     * strike price.
     * <li>CALL Option: if {
     * @latex$ S_{T}>K \rightarrow S_{T}}, otherwise zero</li>
     * <li>PUT Option: if {
     * @latex$ K>S_{T} \rightarrow S_{T}}, otherwise zero</li>
     * where {
