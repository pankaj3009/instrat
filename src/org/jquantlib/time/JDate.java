...
public class JDate implements Observable, Comparable<JDate>, Serializable, Cloneable {
     ...
     *
     * @param m is the desired month, as a number. If you specify 13, you will
    ...
    /**
     * This method is equivalent to C++ sdt:upper_bound function Returns an
     ...
     * <p>
     * <b>NOTE</b>: Both java.util.Date and JQuantLib Date do not support time
     * zones or high precision clocks. In other words, a day <i>always</i> has
     * exactly 84,600 seconds, or 84,600,000 milliseconds.
     *
     * @author Richard Gomes
     */
...
//    	this(25569+(date.getTime()/86400000L));
     ...
     * <p>
     * Method <code>toString</code> would return something like <i>Mon, dd
     * yyyy</i>
     *
     ...
     * <p>
     * Method <code>toString</code> would return something like
     * <i>mm/dd/yyyy</i>
     *
