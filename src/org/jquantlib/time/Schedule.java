...
//                result += skip*Months;
    ...
    /**
     * Standard C++ Library Reference lower_bound Finds the position of the
     * first element in an ordered range that has a value greater than or
     * equivalent to a specified value, where the ordering criterion may be
