 ...
 * <li>Presidents' Day (a.k.a. Washington's birthday), third Monday in
 * February</li>
    ...
    private final class SettlementImpl extends WesternImpl {
        ...
        public boolean isBusinessDay(final JDate date) {
            ...
            if (isWeekend(w)
                    ...
                    || (d == 24 && w == Weekday.Friday)) && m == Month.December)) //                // New Year's Day (possibly moved to Monday if on Sunday)
            //                || ((d == 1 || (d == 2 && w == Weekday.Monday)) && m == Month.January)
            //                // Martin Luther King's birthday (third Monday in JANUARY)
            //                || ((d >= 15 && d <= 21) && w == Weekday.Monday && m == Month.January)
