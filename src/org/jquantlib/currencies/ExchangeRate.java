...
public class ExchangeRate {
    ...
    /**
     * Returns a new ExchangeRate with a initialized ratechain. The ratechain
     * will be initialized by copies of r1 and r1.
     *
    ...
    /**
     * Apply this ExchangeRate an amount of cash. A new money instance will be
     * returned. The input remains unchanged.
     *
     * @param amount The money instance the exchange rate should be applied to.
     * Money
     * @return A new money instance where this ExchangeRate has been applied to.
     * Money
     */
