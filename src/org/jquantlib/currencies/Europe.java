...
public class Europe {
    ...
    /**
     * Bulgarian lev The ISO three-letter code is BGL; the numeric code is 100.
    ...
    /**
     * Belarussian ruble The ISO three-letter code is BYR; the numeric code is
     * 974. It has no subdivisions.
     *
     * @category currencies
     */
    ...
    /**
     * Swiss franc The ISO three-letter code is CHF; the numeric code is 756. It
    ...
    /**
     * Cyprus pound The ISO three-letter code is CYP; the numeric code is 196.
    ...
    /**
     * Czech koruna The ISO three-letter code is CZK; the numeric code is 203.
    ...
    /**
     * Danish krone The ISO three-letter code is DKK; the numeric code is 208.
    ...
    /**
     * Estonian kroon The ISO three-letter code is EEK; the numeric code is 233.
    ...
    /**
     * British pound sterling The ISO three-letter code is GBP; the numeric code
     * is 826. It is divided in 100 pence.
     *
     * @category currencies
     */
    ...
    /**
     * Hungarian forint The ISO three-letter code is HUF; the numeric code is
     * 348. It has no subdivisions.
     *
     * @category currencies
     */
    ...
    /**
     * Icelandic kron The ISO three-letter code is ISK; the numeric code is 352.
    ...
    /**
     * Lithuanian litas The ISO three-letter code is LTL; the numeric code is
     * 440. It is divided in 100 centu.
     *
     * @category currencies
     */
    ...
    /**
     * Latvian lat The ISO three-letter code is LVL; the numeric code is 428. It
     * is divided in 100 santims.
     *
     * @category currencies
     */
    ...
    /**
     * Maltese lira The ISO three-letter code is MTL; the numeric code is 470.
     * It is divided in 100 cents.
     *
     * @category currencies
     */
    ...
    /**
     * Norwegian krone The ISO three-letter code is NOK; the numeric code is
     * 578. It is divided in 100 �re.
     *
     * @category currencies
     */
    ...
    /**
     * Polish zloty The ISO three-letter code is PLN; the numeric code is 985.
    ...
    /**
     * Romanian leu The ISO three-letter code was ROL; the numeric code was 642.
    ...
    /**
     * Romanian new leu The ISO three-letter code is RON; the numeric code is
     * 946. It is divided in 100 bani.
     *
     * @category currencies
     */
    ...
    /**
     * Slovenian tolar The ISO three-letter code is SIT; the numeric code is
     * 705. It is divided in 100 stotinov.
     *
     * @category currencies
     */
    ...
    /**
     * Slovak koruna The ISO three-letter code is SKK; the numeric code is 703.
    ...
    /**
     * Turkish lira The ISO three-letter code was TRL; the numeric code was 792.
    ...
    /**
     * New Turkish lira The ISO three-letter code is TRY; the numeric code is
     * 949. It is divided in 100 kurus.
     *
     * @category currencies
     */
    ...
    /**
     * Austrian shilling The ISO three-letter code was ATS; the numeric code was
     * 40.It was divided in 100 groschen. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Belgian franc The ISO three-letter code was BEF; the numeric code was
     * 56.It had no subdivisions. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Deutsche mark The ISO three-letter code was DEM; the numeric code was
     * 276.It was divided in 100 pfennig. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Spanish peseta The ISO three-letter code was ESP; the numeric code was
     * 724.It was divided in 100 centimos. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Finnish markka The ISO three-letter code was FIM; the numeric code was
     * 246.It was divided in 100 penni�. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * French franc The ISO three-letter code was FRF; the numeric code was
     * 250.It was divided in 100 centimes. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Greek drachma The ISO three-letter code was GRD; the numeric code was
     * 300.It was divided in 100 lepta. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Irish punt The ISO three-letter code was IEP; the numeric code was 372.It
     * was divided in 100 pence. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Italian lira The ISO three-letter code was ITL; the numeric code was 380.
    ...
    /**
     * Luxembourg franc The ISO three-letter code was LUF; the numeric code was
     * 442.It was divided in 100 centimes.. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
     ...
     */
    /**
     * Dutch guilder The ISO three-letter code was NLG; the numeric code was
     * 528.It was divided in 100 cents. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
    ...
    /**
     * Portuguese escudo The ISO three-letter code was PTE; the numeric code was
     * 620.It was divided in 100 centavos. Obsoleted by the Euro since 1999
     *
     * @category currencies
     */
