...
public class Currency implements Cloneable {
     ...
     * <p>
     * Such instances can only act as placeholders and must be reassigned to a
     * valid currency before being used.
     */
    public Currency() {
        // Instances built via this constructor have undefined behavior.
    }
    ...
    protected static class Data implements Cloneable {
        ...
        /**
         * The format will be fed three positional parameters, namely, value,
         * code, and symbol, in this order.
         */
        ...
        /**
         * Constructs a new Data object with a empty curreny object as
         ...
         * @param fractionsPerUnit The fractions per unit of this currency (if
         * any) int
         * @param rounding The rounding scheme used for this currency
         * org.jquantlib.math.Rounding
         * @param formatString The format string used to format the output
         * String
         */
