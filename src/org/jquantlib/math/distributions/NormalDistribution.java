...
/**
 * Provides the probability density function (pdf) of the (unit) normal
 * distribution
 *
 * {
 *
 * @latex[ \frac{1}{\sigma \sqrt{2\pi} } \exp \left(-\frac{(x-\mu)^2}{2\sigma
 * ^2} \right) }
 *
 * @see
 * <a href="http://en.wikipedia.org/wiki/Probability_density_function">Normal
 * Distribution</a>
 *
...
public class NormalDistribution implements Derivative {
    ...
    //
    /**
     * Default constructor which assumes {
     *
     * @latex$ \mu \leftarrow 0.0} and {
     * @latex \sigma \leftarrow 1.0 }.
     */
     ...
     * {@inheritDoc}
     * <p>
     * Computes the Normal distribution at point {
     *
     * @latex$ x }
     *
     * @param x
     * @return the Normal distribution at point {
     * @latex$ x }
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Calculates the first derivative of a Normal distribution at point {
     *
     * @latex$ x }
     *
     * @param x
     * @return the first derivative of a Normal distribution at point {
     * @latex$ x }
     */
    @Override
