 ...
 * n independent yes/no experiments, each of which yields success with
 * probability p. Such a success/failure experiment is also called a Bernoulli
 * experiment or Bernoulli trial. In fact, when n = 1, the binomial distribution
 * is a Bernoulli distribution.
 * <p>
 * The binomial distribution is the basis for the popular binomial test of
 * statistical significance. A binomial distribution should not be confused with
...
public class BinomialDistribution implements Ops.IntToDouble {
     ...
     * </pre> Pre-condition: n must be odd
     */
