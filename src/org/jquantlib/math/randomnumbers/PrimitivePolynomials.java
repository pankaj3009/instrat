 ...
 * <p>
 * The encoding is as follows: Coefficients of each primitive polynomial are the
 * bits of the given integer. The leading and trailing coefficients, which are 1
 * for all of the polynomials, have been omitted.
 * <pre>
 ...
 * </pre>
 *
 * @note Replace this class by the 8129334 polinomials version if you want
 * absolutely all of the provided primitive polynomials modulo two.
 *
