 ...
 * <p>
 * This class wraps a somewhat generic statistic tool and adds a number of risk
 * measures (e.g.: value-at-risk, expected shortfall, etc.) based on the data
 * distribution as reported by the underlying statistic tool.
 * <p>
...
public class GenericRiskStatistics extends GaussianStatistics {
     ...
     *
     * @latex[ \frac{N}{N-1} \mathrm{E}\left[ (x-\langle x \rangle)^2 \;|\; x <
     * \langle x \rangle \right]. }
     *
     * @see Markowitz (1959).
     */
    ...
    /**
     * returns the semi deviation, defined as the square root of the semi
     * variance.
     */
     ...
     * {
     *
     * @latex[ \mathrm{E}\left[ x \;|\; x < \mathrm{VaR}(p) \right], } <p>
     ...
     * @latex[ \Theta(x) = \left\{ \begin{array}{ll} 1 & x < t \\ 0 & x \geq t
     * \end{array} \right. }
     */
