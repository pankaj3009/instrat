 ...
 * Statistics tool
 * <p>
 * This class accumulates a set of data and returns their statistics (e.g: mean,
 * variance, skewness, kurtosis, error estimation, percentile, etc.) based on
 * the empirical distribution (no gaussian assumption)
 * <p>
 * It doesn't suffer the numerical instability problem of IncrementalStatistics.
 * The downside is that it stores all samples, thus increasing the memory
 * requirements.
 *
