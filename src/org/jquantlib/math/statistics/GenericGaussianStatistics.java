 ...
 * <p>
 * This class wraps a somewhat generic statistic tool and adds a number of
 * gaussian risk measures (e.g.: value-at-risk, expected shortfall, etc.) based
 * on the mean and variance provided by the underlying statistic tool.
 *
...
public abstract class GenericGaussianStatistics extends GeneralStatistics {
     ...
     * <p>
     * Assuming a gaussian distribution it returns the expected loss in case
     * that the loss exceeded a VaR threshold,
     * <p>
     * {
     *
     * @latex[ \mathrm{E}\left[ x \;|\; x < \mathrm{VaR}(p) \right], } <p>
     * that is the average of observations below the given percentile {
     * @latex$ p }. Also know as conditional value-at-risk.
     *
