 ...
 * <p>
 * Classes derived from this class will provide interpolated values from two
 * sequences of equal length, representing discretized values of a variable and
 * a function of the former, respectively.
 *
...
public abstract class AbstractInterpolation implements Interpolation {
    ...
    protected abstract class Impl {
        ...
        /**
         * @note Derived classes are responsible for initializing <i>vx</i> and
         * <i>vy</i>
         */
        protected Array vx;
