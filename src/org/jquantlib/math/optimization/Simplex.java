...
/**
 * The implementation of the algorithm was highly inspired by "Numerical Recipes
 * in C", 2nd edition, Press, Teukolsky, Vetterling, Flannery, chapter 10.
 * <p>
 * Modified may 2007: end criteria set on x instead on fx, inspired by bad
 * behaviour found with test function {
 *
 * @latex$ fx=x*x+x+1, xStart = -100, lambda = 1.0, ftol = 1.e-16} (it reports
 * x=0 as the minimum!) and by GSL implementation, v. 1.9
