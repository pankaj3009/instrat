 ...
 * programmer to implement only method <code>forwardImpl(double)</code> in
 * derived classes. Zero yields and discounts are calculated from forwards.
...
public abstract class ForwardRateStructure extends AbstractYieldTermStructure {
    ...
    //
    /**
     * Returns the zero yield rate for the given date calculating it from the
     * instantaneous forward rate.
     *
     * @note This is just a default, highly inefficient and possibly wildly
     * inaccurate implementation. Derived classes should implement their own
     * zeroYield method.
     */
