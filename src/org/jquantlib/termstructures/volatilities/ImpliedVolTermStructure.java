 ...
 *
 * @note It doesn't make financial sense to have an asset-dependent implied
 * Volatility Term Structure. This class should be used with term structures
 * that are time dependent only.
 *
