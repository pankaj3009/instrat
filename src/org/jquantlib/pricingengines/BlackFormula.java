...
public class BlackFormula {
    ...
    public static /*@Real*/ double blackFormula(
        ...
        @Real
        final double result = discount * optionType.toInteger()
    ...
    public static /*@Real*/ double blackFormulaImpliedStdDevApproximation(
        ...
        forward = forward + displacement;
        strike = strike + displacement;
        if (Closeness.isClose(strike, forward)) // Brenner-Subrahmanyan (1988) and Feinstein (1988) ATM approx.
        {
     ...
     * respect to the standard deviation. If T is the time to maturity Black
     * vega would be blackstddevDerivative(strike, forward, stddev)sqrt(T)
     */
     ...
     * volatility. Standard deviation is absoluteVolatility*sqrt(timeToMaturity)
     */
